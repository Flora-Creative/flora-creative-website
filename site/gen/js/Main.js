...
var _user$project$Styles$inlineStyle = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Styles$descriptionStyle = {
	ctor: '::',
	...
	_1: {
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$textTransform(_rtfeldman$elm_css$Css$lowercase),
				_1: {ctor: '[]'}
			}
		}
	}
};
var _user$project$Styles$innerStyle = {
	ctor: '::',
	_0: _rtfeldman$elm_css$Css$margin(_rtfeldman$elm_css$Css$auto),
	_1: {ctor: '[]'}
};
var _user$project$Styles$projectHeaderStyle = {
	ctor: '::',
	_0: _rtfeldman$elm_css$Css$fontSize(
...
var _user$project$Styles$floraHeaderStyle = {
	ctor: '::',
	_0: _rtfeldman$elm_css$Css$fontSize(
		...
		_1: {
			...
			_1: {
				...
				_0: _rtfeldman$elm_css$Css$color(
					_rtfeldman$elm_css$Css$hex('#444140')),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$textAlign(_rtfeldman$elm_css$Css$center),
					_1: {
							...
							_1: {
								...
								_1: {
									...
									_0: A3(
										...
										A4(_rtfeldman$elm_css$Css$rgba, 255, 255, 255, 0.125)),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Styles$defaultStyle = {
	ctor: '::',
	_0: _rtfeldman$elm_css$Css$color(
		_rtfeldman$elm_css$Css$hex('#44140')),
	_1: {
		ctor: '::',
...
var _user$project$Styles$withDefaults = function (styles) {
	return _elm_lang$core$List$concat(
		{
			ctor: '::',
			_0: _user$project$Styles$defaultStyle,
			_1: {
				ctor: '::',
				_0: styles,
				_1: {ctor: '[]'}
...
var _user$project$Styles$classStylePairs = function (class_) {
	var _p1 = class_;
	switch (_p1.ctor) {
		case 'Inner':
			return _rtfeldman$elm_css$Css$asPairs(_user$project$Styles$innerStyle);
		case 'Description':
			return _rtfeldman$elm_css$Css$asPairs(
				_user$project$Styles$withDefaults(_user$project$Styles$descriptionStyle));
		default:
			return A2(_elm_lang$core$List$concatMap, _user$project$Styles$classStylePairs, _p1._0);
	}
};
var _user$project$Styles$classStyle = function (class_) {
	return _elm_lang$html$Html_Attributes$style(
		_user$project$Styles$classStylePairs(class_));
};
var _user$project$Styles$bannerStyle = {
	ctor: '::',
	_0: _rtfeldman$elm_css$Css$backgroundColor(
		_rtfeldman$elm_css$Css$hex('#edeae3')),
	_1: {
		ctor: '::',
		_0: A4(
			...
			_rtfeldman$elm_css$Css$em(4.25),
			_rtfeldman$elm_css$Css$em(2)),
		_1: {
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$marginBottom(
...
var _user$project$Styles$idStyle = function (id_) {
	var _p2 = id_;
	switch (_p2.ctor) {
		case 'Banner':
			return _user$project$Styles$inlineStyle(
				_user$project$Styles$withDefaults(_user$project$Styles$bannerStyle));
		case 'FloraHeader':
			return _user$project$Styles$inlineStyle(
				_user$project$Styles$withDefaults(_user$project$Styles$floraHeaderStyle));
		case 'ProjectHeader':
			return _user$project$Styles$inlineStyle(
				_user$project$Styles$withDefaults(_user$project$Styles$projectHeaderStyle));
		default:
			return _user$project$Styles$inlineStyle(_user$project$Styles$defaultStyle);
	}
};
var _user$project$Styles$homepageNamespace = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('homepage');
var _user$project$Styles$MultiClass = function (a) {
	return {ctor: 'MultiClass', _0: a};
};
var _user$project$Styles$Description = {ctor: 'Description'};
var _user$project$Styles$Inner = {ctor: 'Inner'};
var _user$project$Styles$Defaults = {ctor: 'Defaults'};
var _user$project$Styles$ProjectHeader = {ctor: 'ProjectHeader'};
var _user$project$Styles$FloraHeader = {ctor: 'FloraHeader'};
var _user$project$Styles$Banner = {ctor: 'Banner'};

var _user$project$Apps$view = function (app) {
	return A2(
...
var _user$project$Apps$fromJson = function (jsonApp) {
	return {
		name: 'test',
		gallery: {ctor: '[]'},
		description: 'a test',
...
var _user$project$Apps$App = F5(
	function (a, b, c, d, e) {
		return {name: a, gallery: b, description: c, storeURL: d, colour: e};
	});
...
var _user$project$Main$banner = A2(
	...
	{
		ctor: '::',
		_0: _user$project$Styles$idStyle(_user$project$Styles$Banner),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _user$project$Styles$classStyle(_user$project$Styles$Inner),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Styles$idStyle(_user$project$Styles$FloraHeader),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Styles$idStyle(_user$project$Styles$ProjectHeader),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Styles$classStyle(_user$project$Styles$Description),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('The flora project was conceived as a suite of beautifully simple audio effects, cpu-effective audio effects for iOS devices, reminiscent of stomp-box style effects.'),
							_1: {
								ctor: '::',
								_0: A2(
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text('A simple and intuitive interface is presented with just the right number of parameters to allow users to quickly dial in the perfect sound.'),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Styles$idStyle(_user$project$Styles$Defaults),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: A2(
				_elm_lang$core$List$map,
				_user$project$Apps$view,
				_elm_lang$core$Dict$values(model.apps))
		});
};
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {apps: a, focus: b};
	});
var _user$project$Main$init = function (databaseURL) {
	return {
		ctor: '_Tuple2',
		_0: A2(_user$project$Main$Model, _elm_lang$core$Dict$empty, _elm_lang$core$Maybe$Nothing),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Main$init('backend_url?'),
		view: _user$project$Main$view,
		update: _user$project$Main$update,
		subscriptions: _user$project$Main$subscriptions
	})();
var _user$project$Main$AppClick = function (a) {
	return {ctor: 'AppClick', _0: a};
};
var _user$project$Main$AppLoad = function (a) {
	return {ctor: 'AppLoad', _0: a};
};
